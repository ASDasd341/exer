...
public class CompanyController {
	...
	@GetMapping("/companies/byCompanyCode/{companyCode}")
	public ResponseEntity<CompanyDTO> getCompanyByCompanyCode(@PathVariable String companyCode) throws NotFoundException {
	    Company company = companyService.getCompanyByCompanyCode(companyCode).get();
    ...
    public ResponseEntity<CompanyDTO> updateCompanyPartial(@PathVariable Long id, @RequestBody CompanyDTO companyDTO) {
